...
<body>
  ...
  <section class="corona_update">
    ...
    <div class="count_update d-flex flex-row justify-content-around align-items-center">
      <div>
      ...
      <div>
        <h1 class="count">812</h1>
        <p>current discharge case</p>
      </div>
      <div>
  ...
  <div class="container-fluid sub_section bg-light pt-5 pb-5" id="aboutid">
    ...
    <div class="row pt-5">
      <div id="virus" class="ml-5 col-lg-5 col-md-6 col-12 d-flex justify-content-center align-items-center">
